...
def sig(t):
    t = re.sub(r'(?m)(?<!\\)%.*$','',t)
    # decimal LaTeX: $6{,}4$ e $6{.}4$ sao o MESMO valor que 6,4 / 6.4.
    # Sem esta normalizacao o extrator parte '6{,}4' em '6' e '4', e uma
    # simples uniformizacao de notacao aparece como violacao de freeze --
    # falso positivo que faz o revisor desconfiar da propria checagem.
