...
uses_methods: [aprendizado-ativo, pool-based, llm-como-oraculo, amostragem-por-incerteza, entropia, menor-confianca, few-shot, saida-estruturada]
...
|---|-------|-----------|-------------|
| C1 | Com 100 ouro + 500 prata, o TAM treinado supera o LLM anotador (PROMPTING) em ~4 pts F1 médios | §5.2, Tab. 1, p. 13094 | Cap. 2: lacuna — destilar o LLM para um modelo pequeno é viável com poucas centenas de rótulos |
| C2 | Aquisição por incerteza (entropia, menor confiança) converge mais rápido e mais alto que aleatória sob oráculo-LLM; menor confiança é a melhor | §5.3.2, Fig. 3, p. 13095; Tab. 1 | Cap. 4/5: baseline conceitual do confronto DRI-SL vs US/RS com oráculo ruidoso |
...
| C4 | k-means (diversidade pura) só ganha do aleatório em 1 de 3 datasets — diversidade falha em regime de poucos dados | §5.3.2, p. 13096 | Cap. 2: motiva o desenho híbrido densidade+incerteza do DRI-SL |
| C5 | Prompt importa muito: sem exemplos k-NN o F1 zero-shot cai 21-25 pts em NER; verbalizador de rótulos +2,8 em RE | §5.3.1, Tab. 3, p. 13095 | Cap. 5: paralelo com o efeito do instrumento (RQ do instrumento de saída) |
| C6 | Estudantes superam professores: TAM > LLM anotador para GPT-3 (+27 F1), ChatGPT (+3,3) e GPT-4 (+1,2) | §6.1, Tab. 4, p. 13096; §6.2 | Cap. 2/5: fundamenta a arquitetura destilar-oráculo-para-classificador do FALCO |
| C7 | Anotação ativa com LLM é mais eficiente que geração de dados: ZEROGEN/FEWGEN perdem mesmo com 5.000 amostras sintéticas vs 500 anotadas | §5.2, Tab. 1, p. 13094 | Cap. 2: justifica anotar corpus real em vez de sintetizar dados |

## Números que posso citar
- Tab. 1 (p. 13094; ChatGPT anotador, 100 ouro/500 prata, média±dp de 3 seeds):
  ...
  73,00 / 77,94 / 74,28.
- Tab. 3 (p. 13095): instrução pura vs prompt otimizado: 49,62→70,73 (OntoNotes,
  +k-NN), 55,74→81,33 (CoNLL03, +k-NN), 70,94→73,77 (Re-TACRED, +verbalizador).
- Tab. 4 (p. 13096, OntoNotes): GPT-3 PROMPTING 29,49 vs LLMaAA 56,63; GPT-4
  73,68 vs 74,90.
- Protocolo: pool = treino original; seed 50; lotes de 50 por 9 iterações = 500
  prata; validação/demonstração = mesmos 100 ouro (§5.1, p. 13093).

## Citações diretas (com página)
> "task-specific models trained from LLM-generated labels can outperform their teacher LLMs within only hundreds of annotated examples" (Abstract, p. 13088)
