...
($\approx 1/\sqrt{n_V}$), rotular mais é pagar para medir ruído. Na execução
ponta a ponta da biblioteca (oráculo simulado com ruído realista), o gatilho
(i) encerrou o ciclo em 910 de 1.000 rótulos orçados — o artefato está no
