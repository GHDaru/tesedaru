...
A genetic algorithm over subset membership (population 50, 100
generations, elitism; full configuration and per-cell checkpoints in the
released legacy artifacts) optimizes $L_0$ composition for four
objectives (max/min $\times$ accuracy/macro-F1) at ten sizes.
