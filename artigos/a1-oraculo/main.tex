...
(\texttt{experiments/e0}, \texttt{e0p}). Release of the full underlying
dataset is subject to a separate licensing decision; the paired evaluation
samples and all annotation artifacts are released regardless.
\todo{DOI/Zenodo release antes da submissão}
