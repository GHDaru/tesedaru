...
%
% Uso (decisão do autor, 2026-08-23): no APÊNDICE A (a1-lce/texto.tex),
% dentro de um ambiente figure:
%   \input{3-metodo/esquemas-propostos/esq-lce}
%   Por isso a remissão interna aponta para a equação do próprio apêndice
%   (eq:ap-lce), não para a do Cap. 3.
...
\begin{tikzpicture}[
    ...
    % 66mm: em corpo 12 (o corpo real da tese) a linha da AUC_ideal mede
    % ~64,7mm e transbordava a caixa original de 58mm — achado e medido
    % no teste em 12pt (o overfull interno acusou o valor exato)
    \node[caixa, text width=66mm] (formula) at (10.5,3.5)
