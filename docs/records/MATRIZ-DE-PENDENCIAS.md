...
|----|-----|------|------|------|-------------|--------|
| P-01 | 🔴 | CIE | Fase 3 do FALCO: p-valor da superioridade sem lastro no artefato | `5-resultados-falco` §gate (l.~63–64 e ~698–700); critério pré-registrado no Cap.3 | Cruzar (revisor2 tem acesso ao activelearning); se confirmado, corrigir o p-valor / reavaliar a justificativa da Fase 3 | ABERTA |
