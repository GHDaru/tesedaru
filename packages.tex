...
% \algorithmiccomment removido (algpseudocode)
...
\usepackage{multirow}		% células multi-linha (tabela E4)

% ------------------------------------------------------------------------------


% --- ambientes e pacotes exigidos pelos capítulos portados do draft ---
% amsthm conflita com a classe; \newtheorem nativo basta
\newtheorem{definicao}{Defini\c{c}\~ao}[chapter]
\usepackage{placeins}         % \FloatBarrier
\usepackage{pifont}           % \ding p/ marcas da tabela de lacunas
